...
addpath(genpath('F:\RPS_github\utils'))
...
rps.ri.MeasurementEnsemble = 'random'; % random 0/1, rademacher
...
tfocs.alpha = 1; tfocs.beta = 0.4;
savestr = strcat(dataset,'_',num2str(imSize),'_',rps.ri.MeasurementEnsemble,'_',datestr(now,'dd-mm-yyyy'),'_',datestr(now,'HH_MM'),'.mat');
